        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
            ...
            <div className="flex justify-center py-12 px-4">
                <div className="w-full max-w-xl relative">
                    <button
                        onClick={() => router.back()}
                        className="absolute -top-12 left-0 px-4 py-2 bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors duration-300 text-sm font-medium flex items-center gap-2"
                    >
